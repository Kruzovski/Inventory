...
<tr>
    ...
    <td>
        <?php 
            $ResultLastname = $mysqli->query("SELECT name FROM itemhistory WHERE id =" .$row['ItemHistoryId']) or die($mysqli->error()); 
    ...
    <td>
        <?php
            $ResultDolzhnost = $mysqli->query("SELECT lastname FROM rabotnikhistory WHERE id =" .$row['RabotnikHistoryId']) or die($mysqli->error()); 
            $rowDolzhnost = $ResultDolzhnost->fetch_assoc();
